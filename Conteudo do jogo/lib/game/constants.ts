...
export const MINING_COOLDOWN = 12; // frames between mining hits (prevents frantic spam)
export const MANUAL_MINING_MULT = 1.8;
export const PICKAXE_KNOCKBACK = 3.5; // how far pickaxe bounces back on hit
export const BOOST_CHARGE_TIME = 60; // seconds to fully charge boost
export const BOOST_DURATION = 15; // seconds of boost active
export const BOOST_MINING_MULT = 20; // 20x mining speed during boost

// Pickaxe tier progression
...
export const BLOCK_CONFIGS: Record<BlockType, BlockConfig> = {
  ...
  grass: {
    hp: 8,
    color: "#4CAF50",
    texture: TEX_BASE + "grass_block_side.png",
    xp: 1,
    money: 1,
    particleColors: ["#4CAF50", "#8BC34A", "#795548"],
    crackColor: "#2E7D32",
  },
  dirt: {
    hp: 10,
    color: "#5D4037",
    texture: TEX_BASE + "dirt.png",
    xp: 2,
    money: 1,
    particleColors: ["#5D4037", "#795548", "#6D4C41"],
    crackColor: "#3E2723",
  },
  stone: {
    hp: 25,
    color: "#757575",
    texture: TEX_BASE + "stone.png",
    xp: 5,
    money: 3,
    particleColors: ["#757575", "#9E9E9E", "#616161"],
    crackColor: "#424242",
  },
  andesite: {
    hp: 30,
    color: "#8A8A8A",
    texture: TEX_BASE + "andesite.png",
    xp: 6,
    money: 3,
    particleColors: ["#8A8A8A", "#A0A0A0", "#707070"],
    crackColor: "#505050",
  },
  coal: {
    hp: 40,
    color: "#212121",
    texture: TEX_BASE + "coal_ore.png",
    xp: 12,
    money: 10,
    particleColors: ["#212121", "#424242", "#1B1B1B"],
    crackColor: "#000000",
  },
  iron: {
    hp: 65,
    color: "#D7CCC8",
    texture: TEX_BASE + "iron_ore.png",
    xp: 25,
    money: 25,
    particleColors: ["#D7CCC8", "#BCAAA4", "#8D6E63"],
    crackColor: "#6D4C41",
  },
  copper: {
    hp: 50,
    color: "#E07B50",
    texture: TEX_BASE + "copper_ore.png",
    xp: 18,
    money: 15,
    particleColors: ["#E07B50", "#C76840", "#B85B35"],
    crackColor: "#8B4513",
  },
  lapis: {
    hp: 70,
    color: "#1A47A5",
    texture: TEX_BASE + "lapis_ore.png",
    xp: 30,
    money: 35,
    particleColors: ["#1A47A5", "#2857C5", "#0D3080"],
    crackColor: "#0A2060",
  },
  gold: {
    hp: 110,
    color: "#FBC02D",
    texture: TEX_BASE + "gold_ore.png",
    xp: 60,
    money: 100,
    particleColors: ["#FBC02D", "#F9A825", "#FFD54F"],
    crackColor: "#F57F17",
  },
  redstone: {
    hp: 140,
    color: "#D32F2F",
    texture: TEX_BASE + "redstone_ore.png",
    xp: 80,
    money: 150,
    particleColors: ["#D32F2F", "#F44336", "#B71C1C"],
    crackColor: "#B71C1C",
  },
  diamond: {
    hp: 280,
    color: "#00E5FF",
    texture: TEX_BASE + "diamond_ore.png",
    xp: 250,
    money: 500,
    particleColors: ["#00E5FF", "#18FFFF", "#00B8D4"],
    crackColor: "#006064",
  },
  emerald: {
    hp: 380,
    color: "#00C853",
    texture: TEX_BASE + "emerald_ore.png",
    xp: 400,
    money: 800,
    particleColors: ["#00C853", "#69F0AE", "#00E676"],
    crackColor: "#1B5E20",
  },
  legendary: {
    hp: 700,
    color: "#AA00FF",
    texture: TEX_BASE + "crying_obsidian.png",
    xp: 1500,
    money: 5000,
    particleColors: ["#AA00FF", "#E040FB", "#7C4DFF"],
    crackColor: "#4A148C",
  },
  explosive: {
    hp: 5,
    color: "#FF1744",
    texture: TEX_BASE + "tnt_side.png",
    xp: 50,
    money: 0,
    particleColors: ["#FF1744", "#FF5252", "#FF8A80"],
    crackColor: "#B71C1C",
  },
  chest: {
    hp: 50,
    color: "#8D6E63",
    texture: TEX_BASE + "barrel_side.png",
    xp: 100,
    money: 2000,
    particleColors: ["#8D6E63", "#A1887F", "#BCAAA4"],
    crackColor: "#4E342E",
  },
  mossy_cobblestone: {
    hp: 60,
    color: "#5A7A4A",
    texture: TEX_BASE + "mossy_cobblestone.png",
    xp: 8,
    money: 5,
    particleColors: ["#5A7A4A", "#6B8C5A", "#4A6A3A"],
    crackColor: "#3E5E2E",
  },
  spawner: {
    hp: 200,
    color: "#1A1A2E",
    texture: TEX_BASE + "spawner.png",
    xp: 500,
    money: 1000,
    particleColors: ["#1A1A2E", "#2A2A4E", "#0A0A1E"],
    crackColor: "#000000",
  },
  deepslate: {
    hp: 50,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate.png",
    xp: 8,
    money: 5,
    particleColors: ["#4A4A52", "#5A5A62", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  deepslate_coal: {
    hp: 80,
    color: "#3A3A42",
    texture: TEX_BASE + "deepslate_coal_ore.png",
    xp: 20,
    money: 18,
    particleColors: ["#3A3A42", "#212121", "#4A4A52"],
    crackColor: "#1A1A22",
  },
  deepslate_iron: {
    hp: 130,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate_iron_ore.png",
    xp: 45,
    money: 45,
    particleColors: ["#4A4A52", "#D7CCC8", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  deepslate_copper: {
    hp: 100,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate_copper_ore.png",
    xp: 30,
    money: 28,
    particleColors: ["#4A4A52", "#E07B50", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  deepslate_lapis: {
    hp: 140,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate_lapis_ore.png",
    xp: 55,
    money: 60,
    particleColors: ["#4A4A52", "#1A47A5", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  deepslate_gold: {
    hp: 220,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate_gold_ore.png",
    xp: 110,
    money: 180,
    particleColors: ["#4A4A52", "#FBC02D", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  deepslate_redstone: {
    hp: 280,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate_redstone_ore.png",
    xp: 150,
    money: 280,
    particleColors: ["#4A4A52", "#D32F2F", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  deepslate_diamond: {
    hp: 560,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate_diamond_ore.png",
    xp: 480,
    money: 900,
    particleColors: ["#4A4A52", "#00E5FF", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  deepslate_emerald: {
    hp: 760,
    color: "#4A4A52",
    texture: TEX_BASE + "deepslate_emerald_ore.png",
    xp: 750,
    money: 1500,
    particleColors: ["#4A4A52", "#00C853", "#3A3A42"],
    crackColor: "#2A2A32",
  },
  beacon: {
    hp: 150,
    color: "#79F2F2",
    texture: TEX_BASE + "beacon.png",
    xp: 200,
    money: 500,
    particleColors: ["#79F2F2", "#AEFFFF", "#40E0D0", "#FFFFFF", "#00BFFF"],
    crackColor: "#008B8B",
  },
  dungeon_chest: {
    hp: 30,
    ...
    xp: 0,
    money: 0,
    particleColors: ["#8D6E63", "#A1887F", "#FFD54F", "#BCAAA4"],
    crackColor: "#4E342E",
  },
};
...
// Minecraft destroy stage overlays (0-9)
...
export const MOB_CONFIGS: Record<MobType, MobConfig> = {
  zombie: {
    ...
    money: 30,
    color: "#2E7D32",
    texture: ENTITY_BASE + "zombie/zombie.png",
    width: 24,
    height: 52, // head(8*2.4=19) + body(12*2.4=29) + legs visible
    hitParticles: ["#2E7D32", "#4CAF50", "#388E3C"],
  },
  skeleton: {
    hp: 20,
    speed: 0.5,
    ...
    money: 40,
    color: "#E0E0E0",
    texture: ENTITY_BASE + "skeleton/skeleton.png",
    width: 24,
    height: 52,
    hitParticles: ["#E0E0E0", "#BDBDBD", "#9E9E9E"],
  },
  spider: {
    hp: 18,
    speed: 0.7,
    ...
    money: 20,
    color: "#3E2723",
    texture: ENTITY_BASE + "spider/spider.png",
    width: 44,
    height: 22,
    hitParticles: ["#3E2723", "#4E342E", "#5D4037"],
  },
  creeper: {
    hp: 25,
    speed: 0.35,
    ...
    money: 60,
    color: "#4CAF50",
    texture: ENTITY_BASE + "creeper/creeper.png",
    width: 24,
    height: 50,
    hitParticles: ["#4CAF50", "#66BB6A", "#43A047"],
  },
};
...
export const PICKAXE_TEXTURES: Record<PickaxeTier, string> = {
  ...
  stone:
    "https://raw.githubusercontent.com/InventivetalentDev/minecraft-assets/1.20.1/assets/minecraft/textures/item/stone_pickaxe.png",
  ...
  diamond:
    "https://raw.githubusercontent.com/InventivetalentDev/minecraft-assets/1.20.1/assets/minecraft/textures/item/diamond_pickaxe.png",
  netherite:
    "https://raw.githubusercontent.com/InventivetalentDev/minecraft-assets/1.20.1/assets/minecraft/textures/item/netherite_pickaxe.png",
};

// Minecraft sounds from the assets repo
const SND_BASE =
  "https://raw.githubusercontent.com/InventivetalentDev/minecraft-assets/1.20.1/assets/minecraft/sounds/";

export const SOUNDS = {
  dig: [
    SND_BASE + "dig/stone1.ogg",
    SND_BASE + "dig/stone2.ogg",
    SND_BASE + "dig/stone3.ogg",
    SND_BASE + "dig/stone4.ogg",
  ],
  digDirt: [
    SND_BASE + "dig/gravel1.ogg",
    SND_BASE + "dig/gravel2.ogg",
    SND_BASE + "dig/gravel3.ogg",
    SND_BASE + "dig/gravel4.ogg",
  ],
  digDeepslate: [
    SND_BASE + "dig/stone1.ogg",
    SND_BASE + "dig/stone2.ogg",
  ...
  breakGrass: [
    SND_BASE + "dig/grass1.ogg",
    SND_BASE + "dig/grass2.ogg",
    SND_BASE + "dig/grass3.ogg",
    SND_BASE + "dig/grass4.ogg",
  ],
  breakWood: [
    SND_BASE + "dig/wood1.ogg",
    SND_BASE + "dig/wood2.ogg",
    SND_BASE + "dig/wood3.ogg",
    SND_BASE + "dig/wood4.ogg",
  ],
  breakGlass: [
    SND_BASE + "random/glass1.ogg",
    SND_BASE + "random/glass2.ogg",
    SND_BASE + "random/glass3.ogg",
  ],
  break: [
    SND_BASE + "random/break.ogg",
  ],
  levelUp: [SND_BASE + "random/levelup.ogg"],
  orb: [
    SND_BASE + "random/orb.ogg",
  ],
  explode: [
    SND_BASE + "random/explode1.ogg",
    SND_BASE + "random/explode2.ogg",
    SND_BASE + "random/explode3.ogg",
  ],
  click: [SND_BASE + "random/click.ogg"],
  chest: [
    SND_BASE + "random/chestopen.ogg",
  ],
  mobHit: [
    SND_BASE + "damage/hit1.ogg",
    SND_BASE + "damage/hit2.ogg",
    SND_BASE + "damage/hit3.ogg",
  ],
  zombieHurt: [
    SND_BASE + "mob/zombie/hurt1.ogg",
    SND_BASE + "mob/zombie/hurt2.ogg",
  ],
  zombieDeath: [
    SND_BASE + "mob/zombie/death.ogg",
  ],
  skeletonHurt: [
    SND_BASE + "mob/skeleton/hurt1.ogg",
    SND_BASE + "mob/skeleton/hurt2.ogg",
    SND_BASE + "mob/skeleton/hurt3.ogg",
  ],
  skeletonDeath: [
    SND_BASE + "mob/skeleton/death.ogg",
  ],
  spiderHurt: [
    SND_BASE + "mob/spider/say1.ogg",
    SND_BASE + "mob/spider/say2.ogg",
    SND_BASE + "mob/spider/say3.ogg",
  ],
  spiderDeath: [
    SND_BASE + "mob/spider/death.ogg",
  ],
  creeperHurt: [
    SND_BASE + "mob/creeper/say1.ogg",
    SND_BASE + "mob/creeper/say2.ogg",
  ],
  creeperDeath: [
    SND_BASE + "random/explode1.ogg",
  ],
  music: [
    // Calm / Hal / Piano (classic overworld)
    SND_BASE + "music/game/calm1.ogg",
    SND_BASE + "music/game/calm2.ogg",
    SND_BASE + "music/game/calm3.ogg",
    SND_BASE + "music/game/hal1.ogg",
    SND_BASE + "music/game/hal2.ogg",
    SND_BASE + "music/game/hal3.ogg",
    SND_BASE + "music/game/hal4.ogg",
    SND_BASE + "music/game/piano1.ogg",
    SND_BASE + "music/game/piano2.ogg",
    SND_BASE + "music/game/piano3.ogg",
    // Caves & Cliffs / Wild Update
    SND_BASE + "music/game/a_familiar_room.ogg",
    SND_BASE + "music/game/floating_dream.ogg",
    SND_BASE + "music/game/comforting_memories.ogg",
    SND_BASE + "music/game/an_ordinary_day.ogg",
    SND_BASE + "music/game/bromeliad.ogg",
    SND_BASE + "music/game/one_more_day.ogg",
    SND_BASE + "music/game/stand_tall.ogg",
    SND_BASE + "music/game/wending.ogg",
    SND_BASE + "music/game/infinite_amethyst.ogg",
    SND_BASE + "music/game/echo_in_the_wind.ogg",
    SND_BASE + "music/game/crescent_dunes.ogg",
    SND_BASE + "music/game/left_to_bloom.ogg",
    SND_BASE + "music/game/ancestry.ogg",
    // Creative mode tracks
    SND_BASE + "music/game/creative/creative1.ogg",
    SND_BASE + "music/game/creative/creative2.ogg",
    SND_BASE + "music/game/creative/creative3.ogg",
    SND_BASE + "music/game/creative/creative4.ogg",
    SND_BASE + "music/game/creative/creative5.ogg",
    SND_BASE + "music/game/creative/creative6.ogg",
    // Nether tracks
    SND_BASE + "music/game/nether/nether1.ogg",
    SND_BASE + "music/game/nether/nether2.ogg",
    SND_BASE + "music/game/nether/nether3.ogg",
    SND_BASE + "music/game/nether/nether4.ogg",
    // Underwater / ambient
    SND_BASE + "music/game/water/axolotl.ogg",
    SND_BASE + "music/game/water/dragon_fish.ogg",
    SND_BASE + "music/game/water/shuniji.ogg",
    // Nuance (short interludes)
    SND_BASE + "music/game/nuance1.ogg",
    SND_BASE + "music/game/nuance2.ogg",
  ],
...
// Block type to break sound mapping
export const BLOCK_BREAK_SOUND: Record<string, "breakStone" | "breakDirt" | "breakGrass" | "breakWood" | "breakGlass"> = {
  ...
  diamond: "breakStone",
  emerald: "breakStone",
  legendary: "breakStone",
  deepslate: "breakStone",
  deepslate_coal: "breakStone",
  deepslate_iron: "breakStone",
  deepslate_copper: "breakStone",
  deepslate_lapis: "breakStone",
  deepslate_gold: "breakStone",
  deepslate_redstone: "breakStone",
  deepslate_diamond: "breakStone",
  deepslate_emerald: "breakStone",
  mossy_cobblestone: "breakStone",
  spawner: "breakStone",
  beacon: "breakGlass",
  chest: "breakWood",
  dungeon_chest: "breakWood",
  explosive: "breakStone",
};

// Beacon event definitions with weights (higher = more common)
...
export const ENCHANTMENTS: Enchantment[] = [
  ...
  { id: "aoe_2", name: "Shockwave II", rarity: Rarity.EPIC, description: "Medium Area Damage", value: 0.4 },
  {
    ...
    description: "Drill everything instantly",
    value: 10.0,
  },
];
