  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-white px-6 py-10 page-enter min-h-screen">
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        <p className="text-gray-400 font-medium text-sm mt-2 mb-10 text-center">
          Gestão de coins para jogadores da RedeWhite.
        </p>
        ...
        <form onSubmit={handleLogin} className="w-full flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2 ml-1 mt-1">
            ...
            />
            <label htmlFor="remember" className="text-sm font-semibold text-[#6B6B6B] cursor-pointer">
              Lembrar acesso
            </label>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 rounded-full font-bold text-white shadow-lg transition-all active:scale-95 mt-4 flex items-center justify-center"
