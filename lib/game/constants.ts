...
// Eficiencia: value = quanto soma ao pickStrength (igual upgrade de velocidade)
...
export const FORTUNE_TRIGGER_CHANCE = 0.40;
...
// Custo para reciclar (remover encantamentos)
